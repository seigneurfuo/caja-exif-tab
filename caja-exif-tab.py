...
class ExifPropertyPage(GObject.GObject, Caja.PropertyPageProvider):
  ...
  def get_property_pages(self, files):
    ...
    self.property_label = Gtk.Label('EXIF Info')
    ...
    return Caja.PropertyPage(name="CajaPython::exif", label=self.property_label, page=self.mainWindow),
